...
void MainWindow::initialize() {
    ...
    // hide all UI controls - settings stay at defaults
    ...
    onValChangeFarBox(500.f);  // increased for large terrain

    settings.sceneFilePath = "/Users/fluffy/projects/cs1230/bread/project-7/scenefiles/baguette.json";
}
